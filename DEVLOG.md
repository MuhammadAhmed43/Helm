...
- [0329] chore: track installer icon dimensions
- [0330] docs: record squirrel hook ordering
- [0331] chore: validate forge maker output
...
- [0380] docs: note observed tracking edge case
...
- [0387] docs: refine hover-free wording
- [0388] chore: revisit sidebar dimension
- [0389] style: smooth animation easing curve
- [0390] docs: enumerate click mode states
- [0391] chore: review camera permission flow
...
- [0406] style: simplify shadow stack
- [0407] docs: jot multi-monitor caveat
- [0408] chore: log windows symlink workaround
- [0409] docs: reflect on dark mode tokens
- [0410] chore: confirm mirror toggle default
...
- [0433] chore: dedupe asset paths
- [0434] docs: capture overlay z-index ladder
- [0435] chore: revisit context bridge surface
